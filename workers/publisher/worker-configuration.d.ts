/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/publisher/wrangler.jsonc workers/publisher/worker-configuration.d.ts` (hash: 159493e326dcef4bf58fcda72b981f8f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CAPTURE_BASE_URL" | "CONVEX_EXECUTOR_BASE_URL" | "CONVEX_RENDER_URL" | "SUPPORTED_RENDERER_VERSION" | "WORK_WINDOW_MS" | "BROWSER_CAPTURE_TIMEOUT_MS" | "BROWSER_CLEANUP_GRACE_MS" | "PDF_MAX_BYTES" | "ASSET_PUBLISHER_CACHE_TOKEN_SECRET" | "ASSET_PUBLISHER_EXECUTOR_SECRET">> {}
}
