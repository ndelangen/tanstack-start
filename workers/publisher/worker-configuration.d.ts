/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/publisher/wrangler.jsonc workers/publisher/worker-configuration.d.ts` (hash: 1f86f5588f64c6b3d5d60427d8d4ed65)
