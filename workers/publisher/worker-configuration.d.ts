/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/publisher/wrangler.jsonc workers/publisher/worker-configuration.d.ts` (hash: eab0f40bee5526e73511c20e266a1437)
...
interface __BaseEnv_Env {
	...
	SUPPORTED_RENDERER_VERSION: "unprovisioned";
	...
	ASSET_PUBLISHER_CACHE_TOKEN_SECRET: string;
	ASSET_PUBLISHER_POLL_SECRET: string;
	ASSET_PUBLISHER_EXECUTOR_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLISHER_ENABLED" | "CRON_DISPATCH_ENABLED" | "CAPTURE_BASE_URL" | "CONVEX_POLL_URL" | "CONVEX_EXECUTOR_BASE_URL" | "CONVEX_RENDER_URL" | "SUPPORTED_RENDERER_VERSION" | "EXECUTOR_MAX_ITEMS" | "SOFT_DEADLINE_MS" | "UPLOAD_MARGIN_MS" | "BROWSER_CAPTURE_TIMEOUT_MS" | "BROWSER_CLEANUP_GRACE_MS" | "PDF_MAX_BYTES" | "QUEUE_MAX_PRE_OWNERSHIP_ATTEMPTS" | "QUEUE_RETRY_DELAY_SECONDS" | "R2_STORAGE_CEILING_BYTES" | "R2_ESTIMATED_INVENTORY_BYTES" | "R2_INVENTORY_OBSERVED_AT_MS" | "R2_INVENTORY_MAX_AGE_MS" | "R2_UNACCOUNTED_WRITE_BUDGET_BYTES" | "ASSET_PUBLISHER_CACHE_TOKEN_SECRET" | "ASSET_PUBLISHER_POLL_SECRET" | "ASSET_PUBLISHER_EXECUTOR_SECRET">> {}
}
