/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/publisher/wrangler.jsonc workers/publisher/worker-configuration.d.ts` (hash: e4d4966f7ef9ac22595da64fe0ebe98f)
