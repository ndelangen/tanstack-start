...
import { SideBySide } from '../../components/block/Layout';
        ...
        <Definitions>
          ...
          <dd>
            <p>
              ...
              <br />
              Tells where Spice Blows will create treasure troves of Spice waiting to be harvested,
              and when the giant sandworms known as Shai-Hulud will turn up.
            </p>
          </dd>
          <dt>
            Fate deck
    ...
    <Spaced>
      ...
      <SideBySide>
        ...
        <Text style={{ flex: 1 }}>
          ...
          <ol>
            ...
            <li>
              Discarding them by playing your fate ability, when you have the matching fate card.
            </li>
          </ol>
          <blockquote>
      ...
      <SideBySide>
        ...
        <Text style={{ flex: 1 }}>
          ...
          <p>
            Playing this card in your battle plan will kill the opponent's leader unless they have a
            poison defense in their battle plan.
          </p>
          <p>
    ...
    <Spaced>
      ...
      <SideBySide>
        ...
        <Text style={{ flex: 1 }}>
          <h1>Weirding way</h1>
          <p>
            Playing this card in your battle plan without a second weapon will kill the opponent's
            leader unless they have a projectile defense in their battle plan.
          </p>
          <p>
            Playing this card in your battle plan with a second weapon protect your leader from a
            projectile weapon.
            <br />
      ...
      <SideBySide>
        ...
        <Text style={{ flex: 1 }}>
          ...
          <p>
            If your battle-plan also contains a shield, or your opponent's battle plan contains a
            shield, a lasgun-shield explosion occurs.
            <br />
      ...
      <SideBySide>
        ...
        <Text style={{ flex: 1 }}>
          <h1>Chemistry</h1>
          <p>
            Playing this card in your battle plan with a second defense will kill the opponent's
            leader unless they have a poison defense in their battle plan.
          </p>
          <p>
            Playing this card in your battle plan without a second defense protects your leader from
            a poison weapon.
          </p>
          <p>
    ...
    <Spaced>
      ...
      <SideBySide>
        ...
        <Text style={{ flex: 1 }}>
          ...
          <p>
            Playing this card in your battle plan will defend your leader from projectile weapons in
            your opponent's battle plan.
          </p>
          <p>
            When this card is ever played in combination with a "Lasgun" a lasgun shield explosion
            occurs.
            <br />
      ...
      <SideBySide>
        ...
        <Text style={{ flex: 1 }}>
          ...
          <p>
            Playing this card in your battle plan will defend your leader from poison weapons in
            your opponent's battle plan.
          </p>
          <p>
...
export function KaramaCard() {
  return (
    <Spaced>
      ...
      <SideBySide>
        <div style={{ padding: '2vw 6vw', width: '24vw', flex: 'none' }}>
          <Fan
            size={cardSize}
            spacing={-3}
            style={{ boxShadow: '0.5vw 0.5vw 0.5vw rgba(0, 0, 0, 0.5)', borderRadius: '1vw' }}
        ...
        <Text style={{ flex: 1 }} size={1.7}>
          ...
          <Outline variant="normal">
            ...
            <ol>
              ...
              <li>
                During <strong>your</strong> shipment and movement turn, your shipment cost is
                reduced to half of normal. Your payment for this shipment goes to the Spice Bank.
              </li>
            </ol>
          </Outline>
        </Text>
      ...
      <Text columns={2} size={1.7}>
        <NonBreaking>
          <h1>Full turn</h1>
          <p>
            Playing a karama to block another faction's advantage will cancel this advantage for the
        ...
        <NonBreaking>
          <Text>
            <Outline variant="example">
              <p>
                When you play a karama to stop the Atreides bidding prescience advantage, the
                Atreides can't look at <strong>any</strong> cards that bidding phase.
              </p>
            </Outline>
          </Text>
        </NonBreaking>
      ...
      <Text size={1.7}>
        ...
        <p>
          On each player's faction sheet each advantage that can be karama'd is denoted by a
          "*"-token.
          <br />
          On the second page of their faction sheet is described in detail what happens when this
          ability is blocked/cancelled.
        </p>
        <p>
          Certain advantages have a narrow time-window when you can play the karama to block them.
          This is also described on the second page.
        </p>
        <p>
          <b>EXAMPLES:</b>
        </p>
      ...
      <Text columns={2}>
        <Outline variant="example">
          <p>
            When playing a karama to stop the Spacing Guild from using their storm order advantage
            during ship and move, you must do so before the Spacing Guild was supposed to take their
            turn.
          </p>
        </Outline>
        <Outline variant="example">
          <p>
            When playing a karama to stop the Bene Gesserit from using their voice advantage against
            you, you can listen to what their voice is, but must play the karama before proceeding
            with further actions/revealing.
          </p>
        </Outline>
      </Text>
    </Spaced>
    ...
    <Spaced>
      ...
      <SideBySide>
        ...
        <Text style={{ flex: 1 }} size={1.7}>
          ...
          <Outline variant="normal">
            <p>
              Publicly ask one other player a single yes/no question about the game that must be
              answered publicly.
            </p>
      ...
      <Text columns={2} size={1.7}>
        ...
        <p>
          ...
          <br />
          You must commit to an answer and then you are not allowed to make game actions that would
          make your answer not true.
        </p>
        <p>To be clear: you will be locked into future actions via the answer you give.</p>
        <h1>What questions are allowed?</h1>
        <p>
          Some player discretion is needed, it's possible for extreme toxic play to happen with
          either deliberately unclear questions, or questions that are effectively a card-blanc "you
          must do exactly the thing i decide you must do".
        </p>
        <ul>
          <li>Absolutely, no questions about future truth-trace questions.</li>
          <li>
            No confusing questions, if you need to explain the question, it's not clear enough.
          </li>
          <li>No questions about undecidable future events.</li>
        </ul>
        <p>
          If you asked your question and it turns out to be toxic, you must discard your Truth
          Trance card, you do <strong>not</strong> get to ask another question.
        </p>
      </Text>
      <Text columns={2} size={1.7}>
        <NonBreaking>
          <Text>
            ...
            <Outline variant="example">
              Will you play a projectile weapon, weirding way as a weapon or a lasgun in the next
              battle?
            </Outline>
            <Outline variant="example">
              Will you have more than 4 Troop tokens in Arrakeen by the end of your shipment &
              movement turn?
            </Outline>
          </Text>
        </NonBreaking>
...
export function TreacheryCards4() {
  return (
    <Spaced>
      ...
      <SideBySide>
        <div style={{ padding: '2vw 2vw', width: '24vw', flex: 'none' }}>
          <Fan
            size={cardSize}
            spacing={-3}
            style={{ boxShadow: '0.5vw 0.5vw 0.5vw rgba(0, 0, 0, 0.5)', borderRadius: '1vw' }}
        ...
        <Text style={{ flex: 1 }}>
          <h1>Cheap hero</h1>
          <p>
            There are 3 Cheap Hero cards in the Treachery deck, 2 are called "Cheap Hero", 1 is
            called "Cheap Heroine".
            <br />
          ...
          <p>
            A Cheap Hero card is always discarded after use. Unless you won with Traitor, in that
            case you can chose to keep or discard.
          </p>
      ...
      <SideBySide>
        <div style={{ width: '17vw', flex: 'none' }}>
          <Fan
            size={cardSize}
            spacing={-3}
            style={{ boxShadow: '0.5vw 0.5vw 0.5vw rgba(0, 0, 0, 0.5)', borderRadius: '1vw' }}
        ...
        <Text style={{ flex: 1 }}>
          ...
          <p>
            You can play this card during the storm phase only, after the storm calculation is
            complete, but before the storm is moved.
          </p>
      ...
      <SideBySide>
        ...
        <Text style={{ flex: 1 }}>
          ...
          <p>
            You can play this card during the storm phase only, after the storm calculation is
            complete (and after Weather Control is played), but before the storm is moved.
          </p>
          <p>
            You can only play this card if you have at least 1 Troop token in an territory adjacent
            or on the Shieldwall territory.
            <br />
    ...
    <Spaced>
      ...
      <SideBySide>
        ...
        <Text style={{ flex: 1 }}>
          ...
          <p>
            ...
            <br />
            You can play this card in the battle plan, in addition to playing a weapon and a
            defense.
          </p>
          <p>
      ...
      <SideBySide>
        ...
        <Text style={{ flex: 1 }}>
          ...
          <p>
            When you play the Supplies! card, you discard it and take the 4 Supplies! Treachery
            cards from the supply, into your hand.
            <br />
