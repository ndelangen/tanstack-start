    ...
    <Spaced>
      ...
      <Text columns={2}>
        <NonBreaking>
          ...
          <p>
            Both the treachery discard pile and Spice blow discard piles are public information and
            may be searched at any time by any faction.
          </p>
        </NonBreaking>
        <NonBreaking>
        ...
        <NonBreaking>
          ...
          <p>
            When a faction has one available leader at the revival phase, they may begin the process
            of reviving leaders by paying their leader's strength in Spice.
          </p>
        </NonBreaking>
      </Text>
      <Text>
