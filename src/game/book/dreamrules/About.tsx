...
import { SideBySide, WithBottom } from '../../components/block/Layout';
  ...
  return (
    <Spaced>
      ...
      <Text>
        ...
        <p>
          After playing the game for this long; a long list of mechanics/rules become problematic.
          With the rulebook being open to many interpretations, that would often lead to heated
          debates in games, we decided we wanted to rewrite the rulebook, to remove inconsistencies,
          clear up wording etc.
        </p>
        <p>
          After the Ixian & Tleilaxu expansion and FAQ documents being released we came to
          understand the instead of a rulebook-rewrite, we would have to create ouw own variant of
          the game to fix the issues we had.
        </p>
      ...
      <Spaced>
        ...
        <Text columns={2}>
          ...
          <NonBreaking>
            ...
            <p>
              This document consists of the full rules for the Dream Rules variant of Gale Force
              Nine's reprint of Dune and their Ixian and Tleilaxu expansion.
            </p>
            <p>Dream Rules Dune is a game best played with Six players.</p>
            <p>
              The ruleset has been engineered to increase player engagement and agency as well as to
              remove many random elements and heighten the skill ceiling.
            </p>
            <p>
              More information about design goals etc, can be found on the last page of this rule
              book.
            </p>
          </NonBreaking>
        </Text>
