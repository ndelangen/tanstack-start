  ...
  return (
    <Spaced>
      ...
      <Text>
        <NonBreaking>
          ...
          <p>
            ...
            advantages.
            <br />
            The object of the game is to use these advantages to gain control of Dune. The winners
            are the first players to control 3 Victory Points, or 4 in an Alliance with one other
            player, during the Mentat Pause phase.
          </p>
          <p>
            A faction has special advantages detailed on their faction sheets that may contradict
            the rules. A faction's particular advantages always have precedence over the rules.
          </p>
        </NonBreaking>
      </Text>
      ...
      <Text>
        <NonBreaking>
          <p>
            Printed on the board is a map of the planet Dune. The map contains six types of
            territories.
          </p>
        </NonBreaking>
        <Definitions>
    ...
    <Spaced>
      <Text columns={2}>
        <NonBreaking>
          <h1>Sectors</h1>
          <p>
            The map is also divided by longitude lines into 18 sectors which extend from the edge of
            the Polar Sink to the horizon.
          </p>
          <p>Sectors are important in 3 ways:</p>
          <ol>
            <li>When the storm moves, it moves from sector to sector.</li>
            <li>
              Territories that are under storm cannot be entered or moved through. When a territory
              is partially under storm, these parts act as separate territories.
            </li>
      ...
      <Text columns={2}>
        ...
        <NonBreaking>
          ...
          <p>
            There are a total of 20 locations on the board where Spice can spawn and be collected.
          </p>
          <ul>
          ...
          <p>
            <em>
              TODO: the map on the left should show the locations of the Spice-blows and
              Spice-mines, clearly.
            </em>
          </p>
        </NonBreaking>
      ...
      <Text columns={2}>
        <NonBreaking>
          ...
          <p>
            A unique territory on dune is the polar sink. This territory is safe from everything
          </p>
        </NonBreaking>
        <NonBreaking>
          <ul>
      ...
      <Text columns={2}>
        ...
        <Definitions>
          ...
          <dd>
            ...
            <p>
              If you have Troop tokens here at the collection phase, you gain 2 Spice from the Spice
              bank.
            </p>
          </dd>
          <dt>Carthag</dt>
          ...
          <dd>
            ...
            <p>
              If you have Troop tokens here at the collection phase, you gain 1 Spice from the Spice
              bank.
            </p>
          </dd>
        </Definitions>
        ...
        <p>
          The Shieldwall territory will be a stronghold for victory purposes only. This means that:
        </p>
        <ul>
        ...
        <p>
          When the Shieldwall territory is partially under storm, only the larger part (upper left)
          counts as the stronghold.
        </p>
        <StrongholdsMap />
      </Text>
    </Spaced>
