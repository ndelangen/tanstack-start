  ...
  return (
    <Spaced>
      ...
      <Text columns={2} size={1.8}>
        <p>
          Players can make any kind of verbal deals or bribes between one another. Once made, these
          deals and bribes may be stated aloud and must be honored. A player cannot renege on a deal
          or bribe.
        </p>
        <h2>VALID:</h2>
        <ul>
        ...
        <p>
          Spice exchanged as part of a binding deal is placed in a faction's Bribe pile, in public,
          in front of the player's shield.
        </p>
        <p>
          Players are allowed to offer deals that are impossible for them to actually perform, but
          they are not allowed to accept them.
        </p>
        <p>
          Once a deal has been accepted by both parties, the parts the players want to be binding
          must be stated in public.
        </p>
        <p>
          You can chose to keep details of a deal private, but this can cause bad things to happen:
        </p>
        <ul>
          <li>Players can lie to each other and betray each other.</li>
          <li>
            Private communication was done poorly, and no other players verified what was said.
          </li>
        </ul>
        <h1>Bribes</h1>
        ...
        <p>
          ...
          <em>every faction performs this at the exact same time</em>) that happens at the very end
        ...
        <Outline variant="example">
          <h1>"Thrown fights"</h1>
          <p>
            An very common binding deal revolves around "blocking" strongholds in order to prevent
            other players to win that turn.
          </p>
